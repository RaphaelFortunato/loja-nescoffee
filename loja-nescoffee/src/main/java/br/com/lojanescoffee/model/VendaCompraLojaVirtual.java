...
@Entity
@Table(name = "venda_cp_loja_virt")
@SequenceGenerator(name = "seq_venda_cp_loja_virt", sequenceName = "seq_venda_cp_loja_virt", allocationSize = 1, initialValue = 1)
public class VendaCompraLojaVirtual implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_venda_cp_loja_virt")
	private Long id;
	...
	private Endereco enderecoEntrga;
	...
	public Endereco getEnderecoEntrga() {
		return enderecoEntrga;
	}

	public void setEnderecoEntrga(Endereco enderecoEntrga) {
		this.enderecoEntrga = enderecoEntrga;
	}
